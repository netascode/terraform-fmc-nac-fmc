    ...
    "data" : {
      "fmc" : {
        "objects" : merge(
          ...
          length(local.map_file_types_internal) > 0 ? { "file_types" : local.map_file_types_internal } : {},
          length(local.map_file_categories_internal) > 0 ? { "file_categories" : local.map_file_categories_internal } : {},
          length(local.map_applications_internal) > 0 ? { "applications" : local.map_applications_internal } : {},
          length(local.map_application_business_relevances_internal) > 0 ? { "application_business_relevances" : local.map_application_business_relevances_internal } : {},
          length(local.map_application_categories_internal) > 0 ? { "application_categories" : local.map_application_categories_internal } : {},
          length(local.map_application_risks_internal) > 0 ? { "application_risks" : local.map_application_risks_internal } : {},
          length(local.map_application_tags_internal) > 0 ? { "application_tags" : local.map_application_tags_internal } : {},
          length(local.map_endpoint_device_types_internal) > 0 ? { "endpoint_device_types" : local.map_endpoint_device_types_internal } : {},
          length(local.map_countries_internal) > 0 ? { "countries" : local.map_countries_internal } : {},
          length(local.map_continents_internal) > 0 ? { "continents" : local.map_continents_internal } : {},
        ),
        "policies" : merge(
